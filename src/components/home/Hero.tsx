      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-secondary leading-tight tracking-tight text-balance">
              Scale Smarter with{" "}
              <span className="text-primary">Expert BPO</span> &{" "}
            ...
            <p className="mt-6 text-lg text-text-secondary leading-relaxed max-w-xl mx-auto lg:mx-0">
              Website Development &bull; Real Estate Lead Calling &bull; Custom
              Software &bull; SaaS Products &bull; SEO & Digital Marketing
            </p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-card rounded-3xl shadow-2xl p-8 border border-border">
                ...
                <div className="space-y-4">
                  ...
                  <div className="h-32 bg-primary/10 rounded-xl mt-6 flex items-center justify-center">
                    <svg
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-secondary">+127%</p>
                  </div>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -left-6 bg-card rounded-2xl shadow-xl p-4 border border-border"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-secondary">300+/mo</p>
                  </div>
                </div>
              </motion.div>
            </div>
